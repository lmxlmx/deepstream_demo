 ...
 *
 * @return Pointer to the new batch size query
 */
 ...
 *
 * @return Boolean indicating whether the query is a batch size query.
 */
 ...
 * params[in] batch_size Batch size to be set.
 */
 ...
 *
 * params[in] query A batch size GstQuery.
 * params[out] batch_size Pointer to an unsigned integer in which the function
 *                        will place the batch size.
 *
 * return Boolean indicating whether the query was successfully parsed.
 */
gboolean gst_nvquery_batch_size_parse (GstQuery * query, guint * batch_size);

/**
 * Creates a number of stream query, which can be used by elements to query
 * upstream the number of input sources
 *
 * @return Pointer to the new query
 */
 ...
 * params[in] query The GstQuery to be checked.
 *
 * @return Boolean indicating if the query is a number of streams query.
 */
 ...
 * the number of streams query. This will fail if the query is not of the
 * correct type
 *
 ...
 * params[in] query A number of streams GstQuery.
 * params[out] batch_size Pointer to an unsigned integer in which the function
 *                        will place the number of streams.
 *
 * return Boolean indicating if the query was successfully parsed.
 */
