...
/**
 * @file
 * <b>NVIDIA GStreamer DeepStream: Buffer Structure</b>
 *
...
typedef enum
{
  MEM_RAW,                   /**< CPU allocated dynamic memory */
  MEM_CUDA_PINNED,           /**< Pinned Host memory allocated using cudaMallocHost */
...
typedef struct _NvBufSurface {
    ...
    unsigned int height;
    /** Pitch of the frames contained in the buffer, in bytes. If this is zero,
     * it can be assumed to be equal to the width*/
    unsigned int pitch;
