...
main (int argc, char *argv[])
{
  ...
  GstElement *pipeline = NULL, *source = NULL, *h264parser =
      NULL, *decoder = NULL, *sink = NULL, *pgie = NULL, *vidconv_1 =NULL,
      *vidconv_2 =NULL, *nvvidconv = NULL, *nvosd = NULL, *filter1 = NULL,
      *filter2 = NULL, *caps_filter1 = NULL;
  GstBus *bus = NULL;
  guint bus_watch_id;
...
/*
  ...
  decoder = gst_element_factory_make ("avdec_h264", "libavh264-decoder");

  vidconv_1 = gst_element_factory_make ("videoconvert", "video-converter1");
  vidconv_2 = gst_element_factory_make ("nvvidconv", "video-converter2");
  ...
  caps_filter1 = gst_element_factory_make ("capsfilter", "filter1_1");

  if (!pipeline || !source || !h264parser || !decoder || !vidconv_1 ||!vidconv_2|| !pgie
  ...
  caps1_1 = gst_caps_from_string ("video/x-raw, format=NV12");
  g_object_set (G_OBJECT (caps_filter1), "caps", caps1_1, NULL);
  gst_caps_unref (caps1_1);

  /* Set up the pipeline */
  /* we add all elements into the pipeline */
  gst_bin_add_many (GST_BIN (pipeline),
      source, h264parser, decoder, vidconv_1, caps_filter1, vidconv_2, pgie,
  ...
  gst_element_link_many (source, h264parser, decoder, vidconv_1, caps_filter1 ,vidconv_2, pgie, filter1,
